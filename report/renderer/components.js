...
function createTopbarComponent(dom) {
  ...
  const el44 = dom.createElement('a', 'lh-report-icon lh-report-icon--dark');
  el44.setAttribute('role', 'menuitem');
  el44.setAttribute('tabindex', '-1');
  el44.setAttribute('href', '#');
  el44.setAttribute('data-i18n', 'dropdownDarkTheme');
  el44.setAttribute('data-action', 'toggle-dark');
  el37.append(' ', el38, ' ', el39, ' ', el40, ' ', el41, ' ', el42, ' ', el43, ' ', el44, ' ');
